  ...
  const pageDefs = [
    ...
    },
    {
      ...
      content:
        ...
        "<h3>Наши принципы</h3>" +
        "<ul>" +
        "<li>Оригинальные запчасти в наличии на складе</li>" +
        "<li>Диагностика с выявлением первопричины неисправности и гарантией на выполненные работы</li>" +
        "<li>Письменная смета перед началом работ</li>" +
        "<li>Быстрые сроки благодаря наличию запчастей на складе</li>" +
        "</ul>"
    }
  ];
