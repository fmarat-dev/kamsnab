...
import { openManagerChat, notifyLeadSuccess } from "./lib/max-bridge";

const managerLink = import.meta.env.VITE_MANAGER_MAX_LINK;
...
export default function App() {
  ...
  if (selected) {
    ...
    return (
      <div className="flex flex-col gap-4 p-4">
        ...
        <Button variant="outline" onClick={() => openManagerChat(managerLink)}>
          Написать менеджеру
        </Button>
  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      ...
      <CategoryFilters categories={categories} activeSlug={activeSlug} onSelect={setActiveSlug} variant="dropdown" />
      <div className="grid grid-cols-2 gap-3">
